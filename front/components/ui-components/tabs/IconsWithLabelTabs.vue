...
<template>
    <v-card elevation="0">
        <ClientOnly><v-tabs v-model="tab" bg-color="primary" centered stacked>
            <v-tab value="1" class="no-effect">
                <PhoneIcon stroke-width="1.5" width="20" />
                Recents
            </v-tab>
            <v-tab value="2" class="no-effect">
                <HeartIcon stroke-width="1.5" width="20" />
                Favorites
            </v-tab>
            <v-tab value="3" class="no-effect"> 
