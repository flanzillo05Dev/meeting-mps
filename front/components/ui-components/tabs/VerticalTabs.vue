...
<template>
    <v-row class="d-flex flex-row">
        <v-col cols="12" sm="3">
            <ClientOnly><v-tabs v-model="tab7" direction="vertical" color="primary">
                <v-tab value="option-1" rounded="md" class="mb-3 text-left no-effect" height="70">
                ...
                <v-tab value="option-2" rounded="md" class="mb-3 text-left no-effect" height="70">
                ...
                <v-tab value="option-3" rounded="md" class="mb-3 text-left no-effect" height="70">
                ...
                <v-tab value="option-4" rounded="md" class="mb-3 text-left no-effect" height="70">
