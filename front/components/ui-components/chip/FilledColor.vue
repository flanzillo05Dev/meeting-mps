...
<template>
    <div class="d-flex flex-wrap align-center gap-3">
        ...
        <v-chip class="text-subtitle-1"  color="primary">
            <v-avatar start size="25">
                <img src="/images/profile/profile-5.jpg"  width="25" />
        ...
        <v-chip class="text-subtitle-1"  color="secondary">
        ...
        <v-chip class="text-subtitle-1"  color="success">
            <v-avatar start size="25">
                <img src="/images/profile/profile-6.jpg"  width="25" />
        ...
        <v-chip class="text-subtitle-1"  color="warning">
            <MoodSmileIcon class="mr-2" start size="20" /> Default Filled 
        </v-chip>
        <v-chip class="text-subtitle-1"  color="warning">
            <MoodSmileIcon class="mr-2" start size="20" /> Default Deletable 
        ...
        <v-chip class="text-subtitle-1"  color="error">
            <v-avatar start size="25">
                <img src="/images/profile/profile-7.jpg"  width="25" />
            </v-avatar> Default Filled 
        </v-chip>
        <v-chip class="text-subtitle-1"  color="error">
            <v-avatar start size="25">
