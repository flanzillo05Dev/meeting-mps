<template>
    <v-expansion-panels variant="inset">
        <v-expansion-panel elevation="10">
            ...
            <v-expansion-panel-text class="text-subtitle-1"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget.</v-expansion-panel-text>
